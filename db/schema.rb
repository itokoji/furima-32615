...
ActiveRecord::Schema.define(version: 2021_01_09_031732) do
  ...
  create_table "scheduled_deloveries", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end
